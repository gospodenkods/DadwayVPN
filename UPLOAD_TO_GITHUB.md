# Загрузка Dadway VPN 8.5.9 в GitHub
...
git status
git add --all
git commit -m "Release Dadway VPN 8.5.9"
git push origin main
```

После загрузки откройте **GitHub → Actions → Build Dadway VPN Production APK and AAB**. Для Google Play скачайте артефакт `DadwayVPN-8.5.9-google-play-aab`, для прямой установки — `DadwayVPN-v8.5.9-production-apk`.
