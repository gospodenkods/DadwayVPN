# Dadway VPN 8.5.6 — инструкция пользователя
...
> Иллюстрации ниже повторяют элементы интерфейса версии 8.5.6. Расположение может немного отличаться в зависимости от размера экрана и выбранной темы.
...
При первом запуске 8.5.6 приложение один раз удаляет ранее сохранённые подписки, их кэши и выбранный сервер. Это обеспечивает действительно пустой список после установки обновления. Подписки, добавленные уже в 8.5.6, при следующих запусках не удаляются.
