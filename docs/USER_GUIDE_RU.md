# Dadway VPN 8.5.7 — инструкция пользователя
...
> Иллюстрации ниже повторяют элементы интерфейса версии 8.5.7. Расположение может немного отличаться в зависимости от размера экрана и выбранной темы.
