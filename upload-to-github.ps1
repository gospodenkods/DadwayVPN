...
if ($stagedFiles.Count -gt 0) {
    Invoke-Git -Arguments @("commit", "-m", "Update Dadway VPN v7.5.0-Debug")
}
else {
...
Write-Host "Open GitHub, select Actions, then Build Dadway VPN v7.5.0-Debug APK." -ForegroundColor Green
